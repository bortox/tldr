---
author: ['waldyrious','rubenvereecken','igorshubovych','mebeim','rprieto','agnivade','bl-ue','marchersimon','zlatanvasovic','patricedenis','mfrw','fejx','yasharmaster','subzey','SethFalco','sbrl','qvissak','noarchwastaken','navarroaxel','nsuthison','Vukory','glapa-grossklag','Kreyren','2KAbhishek','ktrueda','iamam34','HakierGrzonzo','artemislena','comradekingu','owenvoke','schneiderl','arunisaac','9tykeshav','LinuxOnTheDesktop','levirs565','shermanhui']
date: 2021-11-17
title: "How to contribute to TLDR Pages"
description: "How to make a contribution and publish a new TLDR page."
---

<sub>Note: the documentation on how to contribute is only in English.</sub>

|Gitter|PRs|Contributors|CLA assistant|LICENSE|
|---|---|---|---|---|
[![Gitter chat][gitter-image]][gitter-url]|[![Merged PRs][prs-merged-image]][prs-merged-url]|[![GitHub contributors][contributors-image]][contributors-url]|[![CLA assistant][cla-assistant-image]][cla-assistant-url]|[![license][license-image]][license-url]
...
Contributions to the tldr-pages project are [most welcome](https://github.com/tldr-pages/tldr/blob/main/GOVERNANCE.md)!
...
refer to the [style guide](https://github.com/tldr-pages/tldr/blob/main/contributing-guides/style-guide.md).
...
* [git](https://github.com/tldr-pages/tldr/blob/main/pages/common/git.md)
* [git-commit](https://github.com/tldr-pages/tldr/blob/main/pages/common/git-commit.md)
* [aws](https://github.com/tldr-pages/tldr/blob/main/pages/common/aws.md)
* [aws-s3](https://github.com/tldr-pages/tldr/blob/main/pages/common/aws-s3.md)
...
A list of translated templates for alias pages can be found in [here](https://github.com/tldr-pages/tldr/blob/main/contributing-guides/translation-templates/alias-pages.md).
...
[using Git on the command-line](https://github.com/tldr-pages/tldr/blob/main/contributing-guides/git-terminal.md).
